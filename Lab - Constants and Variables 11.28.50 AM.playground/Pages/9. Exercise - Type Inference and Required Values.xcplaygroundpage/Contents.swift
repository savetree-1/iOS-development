...
var name: String
// print(name)
print("The code doesnt compile because a variable must be assigned a value before it can be printed")
...
print("The code doesnt compile because the variable distanceTraveled is of type Int and 54.3 is of type Double")
