...
print("This code compiled because 'schooling' is a variable, not a constant. Therefore it can be updated unlike a constant which cannot be changed once initialized.")
