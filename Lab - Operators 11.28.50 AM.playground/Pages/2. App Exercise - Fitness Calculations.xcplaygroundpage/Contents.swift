 ...
 */
let heartRate1: Double = 65
let heartRate2: Double = 88
let heartRate3: Double = 77
let addedHR: Double = heartRate1 + heartRate2 + heartRate3
...
print("This differs from the previous average because we used Double constants")
