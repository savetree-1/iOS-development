...
print("This differs from the value when using integer division because divisionResult is a Double and integerDivisionResult is an Int.")
...
print(even % 2)
print(odd % 2)
print("Looking at the results, I could use the remainder operator to determine if an integer is even or odd by checking the remainder when dividing by 2.")
